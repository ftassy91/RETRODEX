...
| [backend/src/routes/consoles.js](C:/Users/ftass/OneDrive/Bureau/RETRODEXseed/backend/src/routes/consoles.js) | flat legacy duplicate of canonical `/api/consoles*` | canonical runtime already serves `/api/consoles*` from [backend/src/routes/market/catalog.js](C:/Users/ftass/OneDrive/Bureau/RETRODEXseed/backend/src/routes/market/catalog.js) | `candidate_removal` | remove only in an explicit legacy-routes lot |
...
| [backend/src/services/console-service.js](C:/Users/ftass/OneDrive/Bureau/RETRODEXseed/backend/src/services/console-service.js) | legacy/back-office console payload builder | flat [consoles.js](C:/Users/ftass/OneDrive/Bureau/RETRODEXseed/backend/src/routes/consoles.js), `curation-service`, `enrichment-backlog-service` | `keep_non_canonical` | retain until console legacy/admin scope is reviewed separately |
