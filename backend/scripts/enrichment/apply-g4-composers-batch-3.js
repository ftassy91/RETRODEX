...
const G4_BATCH = [
  {
    gameId: 'garou-mark-of-the-wolves-neo-geo',
    title: 'Garou: Mark of the Wolves',
    ostComposers: [
      { name: 'Akihiro Uchida', role: 'composer' },
    ],
    sourceName: 'wikipedia',
    sourceType: 'reference',
    sourceUrl: 'https://en.wikipedia.org/wiki/Garou:_Mark_of_the_Wolves',
    notes: 'Composer curated from Garou: Mark of the Wolves reference credits',
  },
  {
    gameId: 'the-last-blade-2-neo-geo',
    title: 'The Last Blade 2',
    ostComposers: [
      { name: 'SNK Sound Team', role: 'composer' },
    ],
    sourceName: 'vgmdb',
    sourceType: 'reference',
    sourceUrl: 'https://vgmdb.net/album/132211',
    notes: 'Composer curated from The Last Blade 2 Original Soundtrack credits',
  },
  {
    ...
    sourceName: 'electrofans',
    sourceType: 'reference',
    sourceUrl: 'https://www.electrofans.com/30-years-of-a-blue-hedgehog/',
    notes: 'Composer curated from Sonic Chaos retrospective credits',
  },
]
...
function createRun(db, runKey, timestamp, dryRun) {
  const result = db.prepare(`
    INSERT INTO enrichment_runs (
      ...
      0,
      0,
      'Composer uplift batch 3 for published Tier A games'
    )
...
function applyBatch(db, payload) {
  ...
  const runKey = `g4-composers-batch-3-${timestamp}`
  ...
  const metrics = {
    ...
    itemsSkipped: 0,
    itemsFlagged: 0,
    notes: 'G4 composers batch 3 applied locally on staging sqlite',
  }
