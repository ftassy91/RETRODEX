...
const G4_BATCH = [
  {
    gameId: 'judgement-silversword-wonderswan',
    title: 'Judgement Silversword',
    ostComposers: [
      { name: 'M-KAI', role: 'composer' },
    ],
    sourceName: 'vgmdb',
    sourceType: 'reference',
    sourceUrl: 'https://vgmdb.net/album/23471',
    notes: 'Composer curated from ESCHATOS & SILVERSWORD SOUND CHRONICLE credits for Judgement Silversword -Rebirth Edition-',
  },
  {
    gameId: 'kenseiden-sega-master-system',
    title: 'Kenseiden',
    ostComposers: [
      { name: 'George Bruns', role: 'composer' },
      { name: 'Terry Gilkyson', role: 'composer' },
    ],
    sourceName: 'zophar',
    sourceType: 'reference',
    sourceUrl: 'https://www.zophar.net/music/sega-master-system-vgm/kenseiden',
    notes: 'Composer curated from Kenseiden VGM metadata listing George Bruns and Terry Gilkyson',
  },
  {
    gameId: 'pocket-fighter-wonderswan',
    title: 'Pocket Fighter',
    ostComposers: [
      { name: 'Norihiko Togashi', role: 'composer' },
    ],
    sourceName: 'gamefaqs',
    sourceType: 'credits',
    sourceUrl: 'https://gamefaqs.gamespot.com/ps/198303-pocket-fighter/credit',
    notes: 'Composer curated from Pocket Fighter credits showing Norihiko Togashi as Sound WS',
  },
  {
    gameId: 'warbirds-atari-lynx',
    title: 'Warbirds',
    ostComposers: [
      { name: 'Robert Vieira', role: 'composer' },
    ],
    sourceName: 'mobygames',
    sourceType: 'credits',
    sourceUrl: 'https://www.mobygames.com/game/9068/warbirds/credits/',
    notes: 'Composer curated from Warbirds Lynx credits listing Robert Vieira for music',
  },
]
...
function createRun(db, runKey, timestamp, dryRun) {
  const result = db.prepare(`
    INSERT INTO enrichment_runs (
      ...
      0,
      0,
      'G4 composers batch 5 applied on staging sqlite'
    )
...
function applyBatch(db) {
  ...
  const runKey = `g4-composers-batch-5-${timestamp}`
  ...
  const metrics = {
    ...
    itemsSkipped: 0,
    itemsFlagged: 0,
    notes: 'G4 composers batch 5 applied locally on staging sqlite',
  }
