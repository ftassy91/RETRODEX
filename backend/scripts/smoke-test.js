...
const tests = [
  ...
  { name: 'core.css', path: '/css/core.css', check: (_, raw) => raw.includes('--bg') },
  { name: 'components.css', path: '/css/components.css', check: (_, raw) => raw.includes('page-header') },
  { name: 'effects.css', path: '/css/effects.css', check: (_, raw) => raw.includes('phosphor-pulse') },
