...
```powershell
cd "C:\Users\ftass\OneDrive\Bureau\RETRODEX VERSION OK\retrodex_v2_checkpoint_20260313_1722\backend"
...
Le fichier `prototype_v2/debug.html` reste volontairement plus leger :
...
- elle ne remplace pas `prototype_v2/index.html`
