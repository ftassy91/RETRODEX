...
// DATA: local prototype dataset reader.
// STATUS: non-canonical, local-only helper for explicit SQLite sandbox seeding.
// RULE: never import this module from public runtime services or runtime checks.
...
function resolveDataRoot() {
  ...
  if (!fs.existsSync(dataRoot)) {
    throw new Error(`RetroDex prototype data directory not found: ${dataRoot}`)
  }
