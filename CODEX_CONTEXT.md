...
- canonical public surface is [backend/public/](./backend/public/)
- canonical public runtime tree is [backend/src/routes/](./backend/src/routes/)
- canonical public reads are **Supabase-first** through [backend/db_supabase.js](./backend/db_supabase.js)
- local SQLite at [backend/storage/retrodex.sqlite](./backend/storage/retrodex.sqlite) is staging/back-office only
- admin logic is isolated under [backend/src/routes/admin/](./backend/src/routes/admin/) and [backend/src/services/admin/](./backend/src/services/admin/)
- [frontend/](./frontend/) is a secondary prototype area by default
